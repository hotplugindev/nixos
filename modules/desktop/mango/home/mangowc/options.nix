  ...
  options.gb.home.desktop.mango.mangowc = {
    ...
    bindLines = lib.mkOption {
      ...
      default = [
        ...
        "bind=SUPER+SHIFT,V,spawn,dms clipboard clear"
        "bind=NONE,Print,spawn_shell,dms screenshot"
        "bind=CTRL,Print,spawn_shell,dms screenshot full"
        "bind=ALT,Print,spawn_shell,dms screenshot window"
        ...
        "axisbind=SUPER+SHIFT,UP,exchange_client,left"
        "axisbind=SUPER+SHIFT,DOWN,exchange_client,right"
        ...
        "bind=SUPER,comma,viewtoleft_have_client"
        "bind=SUPER,period,viewtoright_have_client"
        ...
        "bind=SUPER+ALT,Equal,incgaps,+5"
        "bind=SUPER+ALT,Minus,incgaps,-5"
