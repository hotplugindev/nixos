...
let
  theme = config.gb.home.dev.nixvim.ui.theme;
in
{
  options = {
    gb.home.dev.nixvim.ui.theme.enable = lib.mkEnableOption "Enable nixvim theme and visual helpers";
  };

  config = lib.mkIf theme.enable {
    programs.nixvim = {
